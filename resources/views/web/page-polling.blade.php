    ...
    <div class="py-2 mb-4">
      ...
      {{-- <ul> --}}
        ...
        <div class="progress mb-2" style="height: 32px;">
          <div class="progress-bar progress-bar-striped bg-warning font-weight-bold" role="progressbar" style="width: {{ ($item->score/$result['total'])*100 }}%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">{{ round(($item->score/$result['total'])*100) }}%</div>
        </div>
        @endforeach
